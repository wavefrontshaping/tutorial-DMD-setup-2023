...
In the first part, we present the diffraction properties of a DMD
and detail how they may affect the efficiency of the system.
We provide a simple criteria for choosing the correct DMD parameters for a given excitation wavelenght.
In the second part, we detail the aberration effects induced but the non-flatness of the DMD surface.
We show how to simply characterize and compensate this effect.
In the third section, we describe the effect of mechanmical vibrations induced by the cooling system of the DMD.
Finally, we show how the thermalization of the DMD chip can induce fluctuations of the DMD response over time.
